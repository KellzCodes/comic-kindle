...
public class ComicProviderTest {
  ...
  private static final Uri TEST_TODAY_ISSUES = ComicContract.IssueEntry.CONTENT_URI_TODAY_ISSUES;
  private static final Uri TEST_OWNED_ISSUES = ComicContract.IssueEntry.CONTENT_URI_OWNED_ISSUES;
  private static final Uri TEST_TRACKED_VOLUMES = ComicContract.TrackedVolumeEntry.CONTENT_URI_TRACKED_VOLUMES;
  ...
  public void testTodayIssuesQuery() {
    ...
    database.insert(ComicContract.IssueEntry.TABLE_NAME_TODAY_ISSUES, null, testValues);
    database.close();
  ...
  public void testOwnedIssuesQuery() {
    ...
    // Insert content via database
    database.insert(ComicContract.IssueEntry.TABLE_NAME_OWNED_ISSUES, null, testValues);
    database.close();

    // Query content via provider
    Cursor queryCursor = contentResolver.query(
        ComicContract.IssueEntry.CONTENT_URI_OWNED_ISSUES,
        null,
        null,
        null,
        null);
  ...
  public void testTrackedVolumesQuery() {
    ...
    // Insert content via database
    database.insert(ComicContract.TrackedVolumeEntry.TABLE_NAME_TRACKED_VOLUMES, null, testValues);
    database.close();

    // Query content via provider
    Cursor queryCursor = contentResolver.query(
        ComicContract.TrackedVolumeEntry.CONTENT_URI_TRACKED_VOLUMES,
        null,
        null,
        null,
        null);
  ...
  public void testRecordsDeletion() {
    ...
    Cursor todayIssues = contentResolver
        .query(ComicContract.IssueEntry.CONTENT_URI_TODAY_ISSUES, null, null, null, null);
    ...
    Cursor ownedIssues = contentResolver
        .query(ComicContract.IssueEntry.CONTENT_URI_OWNED_ISSUES, null, null, null, null);
    ...
    Cursor trackedVolumes = contentResolver
        .query(ComicContract.TrackedVolumeEntry.CONTENT_URI_TRACKED_VOLUMES, null, null, null, null);
    assertEquals("Error: Records were not deleted from owned issues table", 0,
  ...
  public void testTodayIssuesInsert() {
    ...
    contentResolver.insert(ComicContract.IssueEntry.CONTENT_URI_TODAY_ISSUES, testValues);
  ...
  public void testOwnedIssuesInsert() {
    ...
    // Insert content via provider
    contentResolver.insert(ComicContract.IssueEntry.CONTENT_URI_OWNED_ISSUES, testValues);
  ...
  public void testTrackedVolumesInsert() {
    ...
    // Insert content via provider
    contentResolver.insert(ComicContract.TrackedVolumeEntry.CONTENT_URI_TRACKED_VOLUMES, testValues);
  ...
  private void deleteAllRecordsViaProvider() {
    contentResolver.delete(ComicContract.IssueEntry.CONTENT_URI_TODAY_ISSUES, null, null);
    contentResolver.delete(ComicContract.IssueEntry.CONTENT_URI_OWNED_ISSUES, null, null);
    contentResolver.delete(ComicContract.TrackedVolumeEntry.CONTENT_URI_TRACKED_VOLUMES, null, null);
  }
}
