...
import com.kelldavis.comickindle.factory.MainFragmentFactory;
import com.kelldavis.comickindle.helper.ComicPreferenceHelper;
import com.kelldavis.comickindle.manager.ComicSyncManager;
import com.kelldavis.comickindle.presenter.MainActivityPresenter;
import com.kelldavis.comickindle.utils.FragmentUtils;
import com.kelldavis.comickindle.view.MainActivityView;

import javax.inject.Inject;

public class MainActivity extends
    BaseMvpActivity<MainActivityView, MainActivityPresenter>
    implements MainActivityView, OnNavigationItemSelectedListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    String defaultSyncPeriod = comicPreferenceHelper.getSyncPeriod();
  ...
  public void handleChosenNavigationMenuItem(int chosenMenuItem) {
    ...
    if (chosenMenuItem == R.id.nav_issues) {
      ...
      currentSection = AppNavigation.WATCHLIST;
  ...
  public void navigateToCurrentSection() {
    ...
    Fragment fragment = MainFragmentFactory.getFragment(manager, currentSection);

    FragmentUtils.replaceFragmentIn(
        manager, fragment, R.id.content_frame,
        MainFragmentFactory.getFragmentTag(currentSection), false);
